...
const AddBoardModal=(props)=>{
    const handleSubmit=(e)=>{
        e.preventDefault()
        axios.post(`http://127.0.0.1:8000/${props.user_name}/addboard`,{
    ...
    return(
        ...
        <Modal {...props}>
            ...
            <Modal.Title><p className='fs-5 m-0'>Add Board</p></Modal.Title>
            </Modal.Header>
                    ...
                    <Row className='d-flex justify-content-center'>
                        <Col sm={12}>
                            ...
                            <Form.Group controlId="board_name">
                                    <Form.Label className="fs-6 w-100 text-center">Board Name</Form.Label>
                                    <Form.Control type="text" name="board_name" required placeholder="" />
                            </Form.Group>
                            <Form.Group>
